    ...
    return (
        <div className="cursor-pointer w-56 h-68">
            <figure className="relative mb-2 w-full h-4/5" >
                ...
                juego</span>
                <img className="w-full h-full object-cover rounded-lg border-solid border-2 border-black" src="src/assets/data/img/3002.png" />
            ...
            <p className="flex flex-col">
                <span className="font-bold text-sm">Gol al bote</span>
                <span className="text-sm">Crear espacios sin balón</span>
            </p>
        </div>
    )
}
